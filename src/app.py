...
activities.update({
    # Sports
    "Soccer Club": {
        "description": "Team-based soccer practice and local matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["alex@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Indoor basketball training and weekend scrimmages",
    ...
    "Debate Team": {
        "description": "Public speaking, research, and competitive debating",
